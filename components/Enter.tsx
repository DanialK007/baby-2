...
function Enter() {
  ...
  return (
    <>
      <div className={`fixed inset-0 z-999 flex flex-col items-center justify-center text-center gap-5 md:gap-10 bg-rose-600 text-white transition-opacity duration-3000 ease-in ${hide ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
